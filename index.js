  ...
  try {
    ...
    const verifyToken = (req, res, next) => {
      ...
      if (!req.headers.authorization) {
        return res.status(401).send({ message: "unauthorized messages" });
      }
    ...
    app.post("/create-payment-intent", async (req, res) => {
      ...
      app.post("/payments", async (req, res) => {
        ...
        console.log("payment_info", payment);
        const query = {
          _id: {
    ...
    app.get("/admin-stats", async (req, res) => {
      ...
      // );
      //the best way is
      //aggregate or pipeline means step by step any pipeline operation run for optimizing any operation properly without loading.
      ...
      const revenueFixed = revenue.toFixed(2);

      res.send({ users, menuItems, orders, revenueFixed });
    });
